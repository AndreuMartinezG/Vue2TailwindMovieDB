...
<template>
    <div class="flex justify-center items-center md:mx-8 sm:mx-4 sx:mx-4 mx-4">
            ...
            <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1
                        ...
                        Proyect build with <br>Vue2 & TailWind.</h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Free and open-source proyect app, built using the utility classes from Tailwind CSS and based on the
                        components from the Flowbite Library. <br>This is practice for get in hand with Vue framework and
                        learn something on the line.</p>
                    <div class="space-y-4 sm:flex sm:justify-center sm:space-y-0 sm:space-x-4">
                        <a href="https://github.com/AndreuMartinezG/Vue2TailwindMovieDB" target="_blank"
                        ...
                        <a href="https://www.linkedin.com/in/andreumartinezg" target="_blank"
                            class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                            <svg width="16" height="16" viewBox="0 0 48 48" version="1.1"
